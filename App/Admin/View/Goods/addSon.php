	...
	<div class="content">
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-head" >
							<h3 ><button class="btn btn-info">添加子分类</button></h3>
						...
						<div class="box-content">
							<form action="" class="form-horizontal" method="post" id="addCategoryForm">
									<div class="control-group">
										<label for="goods_name" class="control-label">子分类名称</label>
										<div class="controls">
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="pid" style="padding-left:5px;width:224px;">
												...
												{{foreach from="$treeData" value="$v"}}
												<option value="{{$v['cid']}}" {{if value="$v['cid'] eq $_GET['cid']"}}selected{{endif}}>{{$v['_name']}}</option>
												{{endforeach}}
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="goods_type_tid" style="padding-left:5px;width:224px;">
												<option value="{{$typeData['tid']}}" >{{$typeData['tname']}}</option>
											</select>
										</div>
									</div>
