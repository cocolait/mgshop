				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content">
							<form action="{{U('cateImgedit')}}" class="form-horizontal" method="post" id="cateFormOne">
									<div class="control-group">
										...
										<div class="controls">
											<select name="cid"  style="width: 224px;padding-left:5px;" id="cateSelect">
												...
												<option value="{{$v['cid']}}" level="{{$v['_level']}}" {{if value="$oldData['cid'] eq $v['cid']"}}selected{{endif}}>{{$v['_name']}}</option>
												{{endforeach}}
											</select>
										</div>
									</div>
									...
									<div class="control-group" id="levelTwo" >
										...
										<div class="controls">
                                            <input type="hidden" name='mini_imgs_120x120' value="{{$oldData['mini_imgs_120x120']}}"  id="cate_mini_imgs"/>
                                            <input type="file" name='cate_mini' id='cate_mini'/>
										</div>
										<!-- 删除按钮 -->
										<div class="controls" id="mini-hide-show" style="position: relative;padding-top:10px;">
                                            <img alt="" src="{{__ROOT__}}/{{$oldData['mini_imgs_120x120']}}"  class="cate-mini-show" style="width:120px;height:120px;">
									...
									<div class="control-group" id="levelOne1" >
										...
										<div class="controls">
                                            <input type="hidden" name='max_imgs_250x130' value="{{$oldData['max_imgs_250x130']}}"  id="cate_max_250x130"/>
										...
										<div class="controls" id="max-hide-show1" style="position: relative;padding-top:10px;">
                                            <img alt="" src="{{__ROOT__}}/{{$oldData['max_imgs_250x130']}}"  class="max-img-show1" style="width:250px;height:130px;">
									...
									<div class="control-group" id="levelOne2" >
										...
										<div class="controls">
                                            <input type="hidden" name='max_imgs_200x240' value="{{$oldData['max_imgs_200x240']}}"  id="cate_max_200x240"/>
										...
										<div class="controls" id="max-hide-show2" style="position: relative;padding-top:10px;">
                                            <img alt="" src="{{__ROOT__}}/{{$oldData['max_imgs_200x240']}}"  class="max-img-show2" style="width:200px;height:240px;">
